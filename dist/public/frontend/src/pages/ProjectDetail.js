...
const ProjectDetail_module_css_1 = __importDefault(require("../assets/styles/ProjectDetail.module.css"));
const react_1 = require("react");
const assetsPath = "http://localhost:3000/";
function ProjectDetail() {
    ...
    console.log(id);
    return (<div className={ProjectDetail_module_css_1.default.container}>
      {(data === null || data === void 0 ? void 0 : data.leadImage) ? (<div className={ProjectDetail_module_css_1.default.leadImage} style={{
                backgroundImage: `url(${assetsPath + (data === null || data === void 0 ? void 0 : data.leadImage)})`,
            }}></div>) : (<></>)}
      <div className={ProjectDetail_module_css_1.default.wrapper}>
        <h1 className={ProjectDetail_module_css_1.default.title}>{data === null || data === void 0 ? void 0 : data.title}</h1>
        <div className={ProjectDetail_module_css_1.default.description}>
          {data === null || data === void 0 ? void 0 : data.description}
        </div>
        <div className={ProjectDetail_module_css_1.default.flexWrapper}>
          <div className={ProjectDetail_module_css_1.default.techStackWrapper}>
            <h4>Tech Stack Used</h4>
            <ul>
              {data === null || data === void 0 ? void 0 : data.techStack.map((techStack) => (<li>{techStack}</li>))}
            </ul>
          </div>

          <div className={ProjectDetail_module_css_1.default.linkWrapper}>
            <a href={data === null || data === void 0 ? void 0 : data.githubLink} target="__blank">
            ...
            {/* Link Icon */}
            {(data === null || data === void 0 ? void 0 : data.liveLink) && (<a href={data.liveLink} target="__blank">
        ...
        <div className={ProjectDetail_module_css_1.default.selectedImagesWrapper}>
          {data === null || data === void 0 ? void 0 : data.imageLinks.map((imageLink) => (<img src={`${assetsPath}/${imageLink}`}/>))}
        </div>
      </div>
    </div>);
}
