...
// Import Styles
const Navigation_module_css_1 = __importDefault(require("../assets/styles/Navigation.module.css"));
const MobileMenu_module_css_1 = __importDefault(require("../assets/styles/MobileMenu.module.css"));
...
function Navigation() {
    ...
    function toggleHamburgerMenu() {
        ...
        if (mobileMenuElement.classList.contains("mobile__menu__activate")) {
            ...
            const hamburgerElements = document.querySelectorAll("#mobileMenuToggleButton span");
    ...
    return (<nav className={Navigation_module_css_1.default.navigation__container}>
      <MobileMenu />
      {/* Desktop Menu */}
      <ul className={Navigation_module_css_1.default.navigation__row}>
        ...
        <a className={Navigation_module_css_1.default.action__button} href="#ContactSection">
          Contact Me
        </a>
      </ul>

      {/* Mobile Menu */}
      <div className={Navigation_module_css_1.default.mobile__menu__toggle__button} id="mobileMenuToggleButton">
        <label htmlFor="navigationMenuMobileToggleCheck">
          <input type="checkbox" id="navigationMenuMobileToggleCheck" onClick={toggleHamburgerMenu}/>
          <span className={Navigation_module_css_1.default.hamburger__lines}></span>
          <span className={Navigation_module_css_1.default.hamburger__lines}></span>
          <span className={Navigation_module_css_1.default.hamburger__lines}></span>
        </label>
      </div>
...
function MobileMenu() {
    ...
    function toggleHamburgerMenu() {
        ...
        // toggle check class
        const mobileMenuToggleCheck = document.getElementById("navigationMenuMobileToggleCheck");
        if (!mobileMenuToggleCheck)
            return;
        mobileMenuToggleCheck.checked = false;
        mobileMenuElement.classList.toggle("mobile__menu__activate");
    }
    return (<section className={MobileMenu_module_css_1.default.mobile__menu__container} id="MobileMenu">
      ...
      <div className={MobileMenu_module_css_1.default.socials__container}>
        <div className={MobileMenu_module_css_1.default.social__item}>
        ...
        <div className={MobileMenu_module_css_1.default.social__item}>
          <a href="https://www.linkedin.com/in/thomas-alemayehu-6017891a0/" target="__blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 640 640">
