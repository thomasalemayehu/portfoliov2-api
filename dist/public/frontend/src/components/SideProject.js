...
const SideProject_module_css_1 = __importDefault(require("../assets/styles/component/SideProject.module.css"));
function MentionCard({ projectInfo }) {
    const navigate = (0, react_router_dom_1.useNavigate)();
    const { id, title, shortDescription, githubLink, liveLink } = projectInfo;
    return (<div className={SideProject_module_css_1.default.container}>
      {/* title */}
      <h6>{title}</h6>
      <p>{shortDescription}</p>

      <div className={SideProject_module_css_1.default.icon__container}>
        <div onClick={() => {
